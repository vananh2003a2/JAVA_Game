...
public class BackgroundService implements IBackgroundService {
	...
	public void updateBackground() {
		...
		entity1_vot.setImagelink("../assets/img/akagoe/header/headerBackground.png");
		entity1_vot.setIdName("vot");
		BackgroundEntity entity2_vot = new BackgroundEntity();
		entity2_vot.setPageName("introduce");
		entity2_vot.setImagelink("../assets/img/akagoe/introduce/introduceBackground.png");
		entity2_vot.setIdName("vot");
		BackgroundEntity entity3_vot = new BackgroundEntity();
		entity3_vot.setPageName("explore");
		entity3_vot.setImagelink("../assets/img/akagoe/explore/exploreBackground.png");
		...
		entity5_vot.setImagelink("../assets/img/akagoe/review/Backgound.png");
		...
		entity1_soulhalo.setImagelink("../assets/img/akagoe/header/headerBackground.png");
		...
		entity2_soulhalo.setImagelink("../assets/img/akagoe/introduce/introduceBackground.png");
		...
		entity3_soulhalo.setImagelink("../assets/img/akagoe/explore/exploreBackground.png");
		...
		entity4_soulhalo.setImagelink("#E08181");
		...
		entity5_soulhalo.setImagelink("../assets/img/akagoe/review/Backgound.png");
		...
		entity6_soulhalo.setImagelink("#6FB5CF");
		...
		entity1_revivedknight.setImagelink("../assets/img/akagoe/header/headerBackground.png");
		...
		entity2_revivedknight.setImagelink("../assets/img/akagoe/introduce/introduceBackground.png");
		...
		entity3_revivedknight.setImagelink("../assets/img/akagoe/explore/exploreBackground.png");
		...
		entity5_revivedknight.setImagelink("../assets/img/akagoe/review/Backgound.png");
